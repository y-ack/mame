...
ROM_START( gekiridn )
	...
	ROM_REGION( 0x800000, "fdp:sprites" , 0) /* Sprites */
        // 24-bit data bus (three 8-bit roms in parallel)
	ROM_LOAD32_BYTE("e11-03.ic12", 0x000000, 0x200000, CRC(f73877c5) SHA1(1f6b7c0b8a0aaab3e5427d21de7fad3d3cbf737a) )
	ROM_LOAD32_BYTE("e11-02.ic8",  0x000001, 0x200000, CRC(5722a83b) SHA1(823c20a33016a5506ca5415ec615c3d2546ca9ab) )
	ROM_LOAD32_BYTE("e11-01.ic4",  0x000002, 0x200000, CRC(c2cd1069) SHA1(9744dd3d8a6d9200cea4429dafce5620b60e2960) )

	ROM_REGION( 0x800000, "fdp:tiles" , 0) /* Tiles */
        // 48-bit data bus (three 16-bit roms in parallel)
	ROM_LOAD64_WORD("e11-08.ic47", 0x000000, 0x200000, CRC(907f69d3) SHA1(0899ed58edcae22144625c349c9d2fe4d46d11e3) )
	ROM_LOAD64_WORD("e11-07.ic45", 0x000002, 0x200000, CRC(ef018607) SHA1(61b602b13754c3be21caf76acbfc10c87518ba47) )
	ROM_LOAD64_WORD("e11-06.ic43", 0x000004, 0x200000, CRC(200ce305) SHA1(c80a0b96510913a6411e6763fb72bf413fb792da) )
...
GAME( 1992, ringrage,   0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Ring Rage (Ver 2.3O 1992/08/09)", 0 )
GAME( 1992, ringragej,  ringrage, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Ring Rage (Ver 2.3J 1992/08/09)", 0 )
GAME( 1992, ringrageu,  ringrage, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito America Corporation", "Ring Rage (Ver 2.3A 1992/08/09)", 0 )
GAME( 1992, arabianm,   0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Arabian Magic (Ver 1.0O 1992/07/06)", 0 )
GAME( 1992, arabianmj,  arabianm, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Arabian Magic (Ver 1.0J 1992/07/06)", 0 )
GAME( 1992, arabianmu,  arabianm, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito America Corporation", "Arabian Magic (Ver 1.0A 1992/07/06)", 0 )
GAME( 1992, ridingf,    0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Riding Fight (Ver 1.0O)", 0 )
GAME( 1992, ridingfj,   ridingf,  f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Riding Fight (Ver 1.0J)", 0 )
GAME( 1992, ridingfu,   ridingf,  f3, f3, taito_f3_state, init_common,    ROT0,   "Taito America Corporation", "Riding Fight (Ver 1.0A)", 0 )
GAME( 1992, gseeker,    0,        f3, f3, taito_f3_state, init_common,    ROT90,  "Taito Corporation Japan",   "Grid Seeker: Project Storm Hammer (Ver 1.3O)", 0 )
GAME( 1992, gseekerj,   gseeker,  f3, f3, taito_f3_state, init_common,    ROT90,  "Taito Corporation",         "Grid Seeker: Project Storm Hammer (Ver 1.3J)", 0 )
GAME( 1992, gseekeru,   gseeker,  f3, f3, taito_f3_state, init_common,    ROT90,  "Taito America Corporation", "Grid Seeker: Project Storm Hammer (Ver 1.3A)", 0 )
GAME( 1992, commandw,   0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Command War - Super Special Battle & War Game (Ver 0.0J, prototype)", MACHINE_IMPERFECT_GRAPHICS )
...
GAME( 1993, cupfinal,   0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Taito Cup Finals (Ver 1.0O 1993/02/28)", 0 )
GAME( 1993, hthero93,   cupfinal, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Hat Trick Hero '93 (Ver 1.0J 1993/02/28)", 0 )
GAME( 1993, hthero93u,  cupfinal, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Hat Trick Hero '93 (Ver 1.0A 1993/02/28)", 0 )
...
GAME( 1993, gunlock,    0,        f3, f3, taito_f3_state, init_common,    ROT90,  "Taito Corporation Japan",   "Gunlock (Ver 2.3O 1994/01/20)", 0 )
GAME( 1993, gunlocko,   gunlock,  f3, f3, taito_f3_state, init_common,    ROT270, "Taito Corporation Japan",   "Gunlock (Ver 2.0O 1993/12/15)", 0 )
GAME( 1993, rayforcej,  gunlock,  f3, f3, taito_f3_state, init_common,    ROT90,  "Taito Corporation",         "Ray Force (Ver 2.3J 1994/01/20)", 0 )
GAME( 1993, rayforce,   gunlock,  f3, f3, taito_f3_state, init_common,    ROT90,  "Taito America Corporation", "Ray Force (Ver 2.3A 1994/01/20)", 0 )
GAME( 1993, scfinals,   0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Super Cup Finals (Ver 2.2O 1994/01/13, single PCB)", 0 )
GAME( 1993, scfinalso,  scfinals, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Super Cup Finals (Ver 2.1O 1993/11/19, single PCB)", 0 )
GAME( 1993, scfinalsoc, scfinals, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Super Cup Finals (Ver 2.1O 1993/11/19, F3 Cartridge)", 0 )
GAME( 1993, lightbr,    0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Light Bringer (Ver 2.2O 1994/04/08)", 0 )
GAME( 1993, lightbrj,   lightbr,  f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Light Bringer (Ver 2.1J 1994/02/18)", 0 )
GAME( 1993, dungeonm,   lightbr,  f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Dungeon Magic (Ver 2.1O 1994/02/18)", 0 )
GAME( 1993, dungeonmu,  lightbr,  f3, f3, taito_f3_state, init_common,    ROT0,   "Taito America Corporation", "Dungeon Magic (Ver 2.1A 1994/02/18)", 0 )
GAME( 1994, intcup94,   0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "International Cup '94 (Ver 2.2O 1994/05/26)", 0 )
GAME( 1994, hthero94,   intcup94, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito America Corporation", "Hat Trick Hero '94 (Ver 2.2A 1994/05/26)", 0 )
GAME( 1994, kaiserkn,   0,        f3, kn, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Kaiser Knuckle (Ver 2.1O 1994/07/29)", 0 )
GAME( 1994, kaiserknj,  kaiserkn, f3, kn, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Kaiser Knuckle (Ver 2.1J 1994/07/29)", 0 )
GAME( 1994, gblchmp,    kaiserkn, f3, kn, taito_f3_state, init_common,    ROT0,   "Taito America Corporation", "Global Champion (Ver 2.1A 1994/07/29)", 0 )
GAME( 1994, dankuga,    0,        f3, kn, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Dan-Ku-Ga (Ver 0.0J 1994/12/13, prototype)", 0 )
...
GAME( 1994, bublbob2,   0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Bubble Bobble II (Ver 2.6O 1994/12/16)", 0 )
GAME( 1994, bublbob2o,  bublbob2, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Bubble Bobble II (Ver 2.5O 1994/10/05)", 0 )
GAME( 1994, bublbob2p,  bublbob2, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Bubble Bobble II (Ver 0.0J 1993/12/13, prototype)", 0 )
GAME( 1994, bubsymphe,  bublbob2, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Bubble Symphony (Ver 2.5O 1994/10/05)", 0 )
GAME( 1994, bubsymphu,  bublbob2, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito America Corporation", "Bubble Symphony (Ver 2.5A 1994/10/05)", 0 )
GAME( 1994, bubsymphj,  bublbob2, f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Bubble Symphony (Ver 2.5J 1994/10/05)", 0 )
...
GAME( 1994, pwrgoal,    0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Taito Power Goal (Ver 2.5O 1994/11/03)", 0 )
GAME( 1994, hthero95,   pwrgoal,  f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Hat Trick Hero '95 (Ver 2.5J 1994/11/03)", 0 )
GAME( 1994, hthero95u,  pwrgoal,  f3, f3, taito_f3_state, init_common,    ROT0,   "Taito America Corporation", "Hat Trick Hero '95 (Ver 2.5A 1994/11/03)", 0 )
GAME( 1994, hthero95a,  pwrgoal,  f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Hat Trick Hero '95 (Ver 2.6Asia 1994/11/17)", 0 )
GAME( 1994, qtheater,   0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Quiz Theater - 3tsu no Monogatari (Ver 2.3J 1994/11/10)", 0 )
...
GAME( 1995, spcinv95,   0,        f3, f3, taito_f3_state, init_common,    ROT270, "Taito Corporation Japan",   "Space Invaders '95: The Attack Of Lunar Loonies (Ver 2.5O 1995/06/14)", 0 )
GAME( 1995, spcinv95u,  spcinv95, f3, f3, taito_f3_state, init_common,    ROT270, "Taito America Corporation", "Space Invaders '95: The Attack Of Lunar Loonies (Ver 2.5A 1995/06/14)", 0 )
GAME( 1995, akkanvdr,   spcinv95, f3, f3, taito_f3_state, init_common,    ROT270, "Taito Corporation",         "Akkanbeder (Ver 2.5J 1995/06/14)", 0 )
GAME( 1995, twinqix,    0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito America Corporation", "Twin Qix (Ver 1.0A 1995/01/17, prototype)", 0 )
...
GAME( 1995, bubblem,    0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation Japan",   "Bubble Memories: The Story Of Bubble Bobble III (Ver 2.4O 1996/02/15)", 0 )
GAME( 1995, bubblemu,   bubblem,  f3, f3, taito_f3_state, init_common,    ROT0,   "Taito America Corporation", "Bubble Memories: The Story Of Bubble Bobble III (Ver 2.5A 1996/02/21)", 0 )
GAME( 1995, bubblemj,   bubblem,  f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Bubble Memories: The Story Of Bubble Bobble III (Ver 2.3J 1996/02/07)", 0 )
GAME( 1996, cleopatr,   0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Cleopatra Fortune (Ver 2.1J 1996/09/05)", 0 )
GAME( 1996, cleopatro,  cleopatr, f3, f3, taito_f3_state, init_common,    ROT0,   "bootleg",                   "Cleopatra Fortune (Ver 2.1O 1996/09/05, bootleg)", 0 )
...
GAME( 1997, kirameki,   0,        f3, f3, taito_f3_state, init_common,    ROT0,   "Taito Corporation",         "Kirameki Star Road (Ver 2.10J 1997/08/29)", 0 )
